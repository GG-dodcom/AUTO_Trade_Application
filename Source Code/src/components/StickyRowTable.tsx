...
export const StickyRowTable = <T,>({
	...
	return (
		<div className={`custom-scrollbar relative overflow-x-auto ${className}`}>
			<table className="w-full text-sm text-left text-gray-500">
				<thead className="text-xs text-gray-700 uppercase bg-gray-50">
					{/* First Row of Header */}
					{header1Groups && (
						<tr className="sticky top-0 z-10 bg-gray-50 shadow-md border-b border-gray-400">
							...
							{header1Groups.map((group, index) => (
								<th
									...
									className={`px-4 py-4 text-center border-b border-gray-400 ${
					...
					<tr className="sticky top-10 z-10 bg-gray-50 shadow-md">
						<th className="w-12" />
						{columns.map((col, colIndex) => (
							<th
								key={String(col.key)}
								className={`px-4 py-4 whitespace-nowrap overflow-hidden text-ellipsis border-b border-gray-200 ${
